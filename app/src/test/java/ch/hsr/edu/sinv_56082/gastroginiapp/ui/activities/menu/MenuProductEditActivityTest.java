...
public class MenuProductEditActivityTest {
    ...
    public void testSetup(){
        MenuProductEditActivity activity = Robolectric.buildActivity(MenuProductEditActivity.class).withIntent(intent).create().get();
        assertEquals(activity.isNewProduct, true);
    }
